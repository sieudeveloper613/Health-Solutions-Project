...
public class CategoryStoreActivity extends AppCompatActivity {
    // View and ViewGroup
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customToolBar("Bách hóa tổng hợp");
        // Define Reference
    ...
    private void customToolBar(String titleString){
        MaterialToolbar materialToolbar = findViewById(R.id.mToolbar_store);
    ...
    private void initView() {
         ...
         searchView = findViewById(R.id.sv_store);
    }
                    ...
                    if(response.body().getStatus().equals(Constants.SUCCESS)){
                        if (response.body().getResult() == Constants.RESULT_1){
                            ...
                            GridLayoutManager gridLayoutManager =
                                    new GridLayoutManager(CategoryStoreActivity.this, 2);
                            gridLayoutManager.setOrientation(RecyclerView.VERTICAL);
                            recyclerView.setLayoutManager(gridLayoutManager);

                            adapter = new ProductAdapter(CategoryStoreActivity.this, productList);
                            recyclerView.setAdapter(adapter);

                        }
                    }else{
                        Toast.makeText(CategoryStoreActivity.this, "NO GET DATA", Toast.LENGTH_SHORT).show();
                    }
                }
            }
