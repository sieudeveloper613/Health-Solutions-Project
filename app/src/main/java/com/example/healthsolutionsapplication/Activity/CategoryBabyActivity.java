...
public class CategoryBabyActivity extends AppCompatActivity {
    // View and ViewGroup
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_baby);
        changeStatusBarColor();
        customToolBar("Mẹ và Bé");
        // Define Reference
    ...
    private void customToolBar(String titleString){
        MaterialToolbar materialToolbar = findViewById(R.id.mToolbar_baby);
    ...
    private void initView() {
         recyclerView = findViewById(R.id.rv_baby);
         searchView = findViewById(R.id.sv_baby);
    }
                    ...
                    if(response.body().getStatus().equals(Constants.SUCCESS)){
                        if (response.body().getResult() == Constants.RESULT_1){
                            ...
                            GridLayoutManager gridLayoutManager =
                                    new GridLayoutManager(CategoryBabyActivity.this, 2);
                            gridLayoutManager.setOrientation(RecyclerView.VERTICAL);
                            recyclerView.setLayoutManager(gridLayoutManager);

                            adapter = new ProductAdapter(CategoryBabyActivity.this, productList);
                            recyclerView.setAdapter(adapter);

                        }
                    }else{
                        Toast.makeText(CategoryBabyActivity.this, "NO GET DATA", Toast.LENGTH_SHORT).show();
                    }
                }
            }
