...
public class CategoryHealthActivity extends AppCompatActivity {
    // View and ViewGroup
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_health);
        changeStatusBarColor();
        customToolBar("Sức khỏe và làm đẹp");
        // Define Reference
    ...
    private void customToolBar(String titleString){
        MaterialToolbar materialToolbar = findViewById(R.id.mToolbar_health);
    ...
    private void initView() {
         recyclerView = findViewById(R.id.rv_health);
                    ...
                    if(response.body().getStatus().equals(Constants.SUCCESS)){
                        if (response.body().getResult() == Constants.RESULT_1){
                            ...
                            GridLayoutManager gridLayoutManager =
                                    new GridLayoutManager(CategoryHealthActivity.this, 2);
                            gridLayoutManager.setOrientation(RecyclerView.VERTICAL);
                            recyclerView.setLayoutManager(gridLayoutManager);

                            adapter = new ProductAdapter(CategoryHealthActivity.this, productList);
                            recyclerView.setAdapter(adapter);

                        }
                    }else{
                        Toast.makeText(CategoryHealthActivity.this, "NO GET DATA", Toast.LENGTH_SHORT).show();
                    }
                }
            }
