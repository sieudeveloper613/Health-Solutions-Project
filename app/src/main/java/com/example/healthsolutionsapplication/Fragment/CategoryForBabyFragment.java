...
public class CategoryForBabyFragment extends Fragment implements View.OnClickListener{
    // View and ViewGroup
    MaterialCardView cardItemBaby;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_for_baby, container, false);
    ...
    private void initView(View view) {
        cardItemBaby = view.findViewById(R.id.card_itemBaby);
        recyclerView = view.findViewById(R.id.rv_Itembaby);

        // set event
        cardItemBaby.setOnClickListener(this::onClick);
    }
