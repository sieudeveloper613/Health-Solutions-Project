...
public class CategoryForHealthFragment extends Fragment implements View.OnClickListener{
    // View and ViewGroup
    MaterialCardView cardItemHealth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_for_health, container, false);
    ...
    private void initView(View view) {
        cardItemHealth = view.findViewById(R.id.card_itemHealth);
        recyclerView = view.findViewById(R.id.rv_itemHealth);

        // set event
        cardItemHealth.setOnClickListener(this::onClick);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.card_itemHealth:
